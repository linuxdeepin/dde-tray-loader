...
public:
    ...
    bool hasArt() const;
    // Display name of the player, the MPRIS "Identity" property once it has
    // been fetched, the service name without its prefix until then.
...
private:
    ...
    void fetchPlayerIdentity(const QString &path);
