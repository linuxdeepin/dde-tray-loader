...
struct DisplayRect{
    ...
    explicit operator QRect() const { return QRect(x, y, width, height); }
};
...
QDebug operator<<(const QDebug &deg, const DisplayRect &rect);
...
public:
    static inline const char *staticInterfaceName() { return "com.deepin.daemon.Display"; }

    static inline const char *staticServiceName() { return "com.deepin.daemon.Display"; }

    static inline const char *staticObjectPath() { return "/com/deepin/daemon/Display"; }
